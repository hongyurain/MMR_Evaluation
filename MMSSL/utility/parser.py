...
def parse_args():
    ...
    #train
    parser.add_argument('--data_path', nargs='?', default='/home/hongyu/MMSSL/MMSSL/Data/', help='Input data path.')
    ...
    parser.add_argument('--lr', type=float, default=0.0056, help='Learning rate.')
    parser.add_argument('--emm', default=1e-3, type=float, help='for feature embedding bpr')  #
    parser.add_argument('--L2_alpha', default=1.4e-2, type=float, help='')  #
